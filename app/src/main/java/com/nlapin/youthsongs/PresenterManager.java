...
public class PresenterManager {
    ...
    private final Cache<Long, BaseContract.BasePresenter<?>> presenters;
    ...
    public <P extends BaseContract.BasePresenter<?>> P restorePresenter(Bundle savedInstanceState) {
    ...
    public void savePresenter(BaseContract.BasePresenter<?> presenter, Bundle outState) {
